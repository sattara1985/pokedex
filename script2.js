...
// Aquí estamos declarando otra variable llamada "pokemons_number" y le damos el valor de 151. Esto significa que queremos obtener información sobre los primeros 151 pokémon.
...
const fetchPokemons = async () => {
    // Aquí estamos usando un "for loop" para repetir ciertas instrucciones varias veces. La "i" representa un número, y comenzamos en 1. Seguiremos repitiendo las instrucciones hasta llegar al número 151.
    ...
    // Una vez que hemos obtenido información sobre todos los 151 pokémon, llamamos a otra función llamada "createPokemonCard" para mostrar los pokémon en la página web.
